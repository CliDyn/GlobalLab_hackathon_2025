#!/usr/bin/env python3
"""
Database module for storing Dark_Doldrums analysis results.
...
- events: Individual dark_doldrums events
...
class Dark_DoldrumsDB:
    """Database interface for Dark_Doldrums results."""
    
    def __init__(self, db_path="dark_doldrums_results.db"):
    ...
    def _create_tables(self):
        ...
        # Events table - individual dark_doldrums events
        cursor.execute("""
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS annual_stats (
                ...
                n_events INTEGER,
                total_dark_doldrums_hours INTEGER,
    ...
    def add_events(self, run_id, events):
        """
        Add dark_doldrums events for a run.
    ...
    def add_annual_stats(self, run_id, year, stats):
        ...
        cursor.execute("""
            ...
            (run_id, year, mean_cf, std_cf, min_cf, max_cf, hours_below_threshold,
             n_events, total_dark_doldrums_hours, max_duration_hours, max_severity)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    def compare_scenarios(self, region, model, scenario1, scenario2):
        ...
        comparison = pd.DataFrame({
            ...
            f'{scenario1}_mean': [
                ...
                stats1['total_dark_doldrums_hours'].mean(),
            ...
            f'{scenario2}_mean': [
                ...
                stats2['total_dark_doldrums_hours'].mean(),
...
if __name__ == "__main__":
    # Example usage
    db = Dark_DoldrumsDB("dark_doldrums_results.db")
